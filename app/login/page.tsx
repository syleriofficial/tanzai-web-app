        ...
        <div className="relative z-10 p-12 max-w-md">
          ...
          <blockquote className="space-y-4">
            <p className="text-xl font-medium text-foreground leading-relaxed text-balance">
              &ldquo;Tanzai completely transformed how I approach research. I finish in hours what used to take days.&rdquo;
            </p>
            <footer className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">Research Lead, Nexus Institute</p>
              </div>
            </footer>
          </blockquote>
          ...
          <div className="mt-12 glass rounded-2xl border border-border/50 p-5 space-y-3">
            <div className="flex gap-2.5 items-start">
              ...
              <p className="text-sm text-foreground leading-relaxed">
                I&apos;ve analyzed your dataset. The key insight is a{' '}
                <span style={{ color: 'oklch(0.78 0.18 210)' }}>34% correlation</span>{' '}
                between engagement and morning sessions. Want me to generate a full report?
              </p>
            </div>
