              ...
              <>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Tanzai User</p>
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      type="email"
                      readOnly
                      className="w-full bg-input border border-border rounded-xl px-4 py-2.5 text-sm text-muted-foreground focus:outline-none transition-all"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <textarea
                      placeholder="Tell Tanzai about yourself"
                      rows={3}
            ...
            {activeSection === 'memory' && (
              <>
                ...
                <div className="flex items-center justify-between py-4 border-b border-border/40">
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground mt-0.5">
                      Tanzai will remember context across sessions when memory is connected.
                    </p>
                  </div>
                  ...
                  <button
                    ...
                    className={cn(
                      'relative w-10 rounded-full border transition-colors',
                      memoryOn ? 'bg-primary border-primary' : 'bg-muted border-border'
                    )}
                    style={{ height: '22px' }}
                    role="switch"
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground mb-3">No saved memories yet.</p>

                  <div className="rounded-xl border border-border/40 bg-muted/30 px-4 py-4 text-sm text-muted-foreground">
                    Memories will appear here after Tanzai starts saving useful preferences.
                  </div>
              ...
              <>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <input type="password" placeholder="Current password" className="w-full bg-input border border-border rounded-xl px-4 py-2.5 text-sm text-foreground focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary/50 transition-all" />
                  </div>

                  <div>
                    <label className="block text-sm font-medium text-foreground mb-1.5">New password</label>
                    <input type="password" placeholder="New password" className="w-full bg-input border border-border rounded-xl px-4 py-2.5 text-sm text-foreground focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary/50 transition-all" />
                  </div>

                  <div>
                    <label className="block text-sm font-medium text-foreground mb-1.5">Confirm new password</label>
                    <input type="password" placeholder="Confirm new password" className="w-full bg-input border border-border rounded-xl px-4 py-2.5 text-sm text-foreground focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary/50 transition-all" />
                  </div>
                </div>
                ...
                <div className="border-t border-border/50 pt-4">
                  ...
                  <div className="rounded-xl border border-border/40 bg-muted/30 px-4 py-4 text-sm text-muted-foreground">
                    Session management will appear here after device tracking is connected.
                  </div>
                </div>
              </>
            )}
              ...
              <>
                ...
                <div className="glass rounded-xl border border-border/50 p-5">
                  ...
                  <p className="text-xs text-muted-foreground mb-4">
                    Upgrade plans will be connected here when billing is enabled.
                  </p>
